...
// //         .join("");
// // }
// // Helper function to generate tech stack based on project data or category
// function generateTechStack(category, techStackAttr) {
//     let techStack = [];
...
//         "Firebase": { path: "assets/images/firebase.svg", alt: "Firebase icon" },
//         "REST API": { path: "assets/images/api.svg", alt: "REST API icon" },
//         "React Native": { path: "assets/images/React Native..png", alt: "React Native icon" },
//         "JavaScript": { path: "assets/images/javascript.svg", alt: "JavaScript icon" },
//         "TypeScript": { path: "assets/images/typeScript.svg", alt: "TypeScript icon" },
//         "Redux": { path: "assets/images/Redux.png", alt: "Redux icon" },
//         "Context API": { path: "assets/images/context API.png", alt: "Context API icon" },
//         "GitHub": { path: "assets/images/github.svg", alt: "GitHub icon" },
//         "VS Code": { path: "assets/images/visual-studio-code.svg", alt: "VS Code icon" },
//         "Figma": { path: "assets/images/figma.svg", alt: "Figma icon" },
//         // Add new icons for missing technologies
//         "OneSignal": { path: "assets/images/onesignal.svg", alt: "OneSignal icon" },
//         "In App Update": { path: "assets/images/update.svg", alt: "In App Update icon" }, // Add appropriate icon
//         "Firebase Analytics": { path: "assets/images/firebase.svg", alt: "Firebase Analytics icon" }, // Reuse Firebase icon or add specific one
//         "Sentry": { path: "assets/images/sentry.svg", alt: "Sentry icon" },
//         "DeepLink": { path: "assets/images/deeplink.svg", alt: "DeepLink icon" }, // Add appropriate icon
//         "Social Integration": { path: "assets/images/social.svg", alt: "Social Integration icon" } // Add appropriate icon
//     };

//     // If data-tech-stack attribute exists, use it
//     if (techStackAttr) {
//         techStack = techStackAttr.split(",").map(tech => tech.trim());
//     } else {
//         // Common technologies
//         const commonTech = ["GitHub", "VS Code", "Figma"];
...
//         // Category-specific technologies
//         if (category === "Flutter") {
//             const flutterTech = ["Flutter", "Dart", "Provider", "Bloc", "Firebase", "REST API"];
//             techStack = [...flutterTech, ...commonTech];
//         } else if (category === "React Native") {
//             const reactNativeTech = [
//                 "React Native",
...
//             techStack = [...reactNativeTech, ...commonTech];
//         } else if (category === "web development") {
//             const webTech = ["HTML", "CSS", "JavaScript", "React.js", "Node.js", "MongoDB"];
//             techStack = [...webTech, ...commonTech];
//         } else if (category === "mobile applications") {
//             const mobileTech = ["Flutter", "React Native", "Firebase", "REST API", "Redux"];
//             techStack = [...mobileTech, ...commonTech];
//         } else {
//             techStack = ["Flutter", "React Native", "Firebase", ...commonTech];
//         }
...
// Combine DOMContentLoaded listeners for efficiency
document.addEventListener("DOMContentLoaded", function () {
    // AOS initialization
    AOS.init({
        once: true,
    ...
    function typeEffect() {
        if (preloaderText && preloader && mainContent) {
            if (index < text.length) {
                preloaderText.innerHTML += text.charAt(index);
                index++;
    ...
    function generateTechStack(category, techStackAttr) {
        ...
        const techIcons = {
            ...
            "Firebase": { path: "assets/images/firebase.svg", alt: "Firebase icon" },
            "REST API": { path: "assets/images/api.svg", alt: "REST API icon" },
            "MMKV": { path: "assets/images/objectbox.png", alt: "MMKV" },
            "Jest":{path:'assets/images/jest.svg',alt:'Jest'},
            "Google Play":{path:'assets/images/google-play.png',alt:'Jest'},
            "App Store":{path:'assets/images/app-store.svg',alt:'Jest'},
            
            "React Native": { path: "assets/images/React Native..png", alt: "React Native icon" },
            "JavaScript": { path: "assets/images/javascript.svg", alt: "JavaScript icon" },
            "TypeScript": { path: "assets/images/typeScript.svg", alt: "TypeScript icon" },
            "Redux": { path: "assets/images/Redux.png", alt: "Redux icon" },
            "Socket": { path: "assets/images/socketio.svg", alt: "Socket icon" },
            "Context API": { path: "assets/images/React Native..png", alt: "Context API icon" },
            "GitHub": { path: "assets/images/github.svg", alt: "GitHub icon" },
            "Cursor": { path: "assets/images/cursor-ai.svg", alt: "Cursor icon" },
            "React Query": { path: "assets/images/react-query.svg", alt: "React Query icon" },
            "Twitter": { path: "assets/images/twitterr.png", alt: "Twitter icon" },
            "Deeplink": { path: "assets/images/deeplink.png", alt: "Deeplink icon" },
            "VS Code": { path: "assets/images/visual-studio-code.svg", alt: "VS Code icon" },
            "Figma": { path: "assets/images/figma.svg", alt: "Figma icon" },
            "OneSignal": { path: "assets/images/onesignal.svg", alt: "OneSignal icon" },
            "Push Notification":{path:"assets/images/notification.png",alt:"Notification"},
            "Google Map":{path:"assets/images/google-map.svg",alt:"Google Map"},
            "In App Update": { path: "assets/images/update.svg", alt: "In App Update icon" },
            "Firebase Crashlytics":{path:'assets/images/firebase-crashlytics.png',alt:"Firebase Crashlytics"},
            "Firebase Analytics": { path: "assets/images/firebase.svg", alt: "Firebase Analytics icon" },
            "Sentry": { path: "assets/images/sentry.svg", alt: "Sentry icon" },
            "DeepLink": { path: "assets/images/deeplink.svg", alt: "DeepLink icon" },
            "Social Integration": { path: "assets/images/social.svg", alt: "Social Integration icon" },
            "Stripe": { path: "assets/images/stripe.svg", alt: "Stripe icon" },
            "Google ML Kit": { path: "assets/images/google-map.svg", alt: "Google ML Kit icon" },
            "Supabase": { path: "assets/images/supabase.svg", alt: "Supabase icon" },
            "GraphQL": { path: "assets/images/graphql.svg", alt: "GraphQL icon" }
        };

        // Use data-tech-stack if available, otherwise fall back to category
        if (techStackAttr) {
            techStack = techStackAttr.split(",").map(tech => tech.trim());
        } else {
            const commonTech = ["GitHub", "VS Code", "Figma"];
    ...
    document.querySelectorAll(".project-item").forEach((item) => {
        item.addEventListener("click", function (e) {
            ...
            const category = this.getAttribute("data-category");
            const techStackAttr = this.getAttribute("data-tech-stack");
            ...
            document.getElementById("case-study-content").innerHTML = `
                <div class="case-study-container" style="padding: 20px 20px;">
                    ...
                    <div style="margin: 40px 0;">
                        ...
                        <div class="framework-pills">
                            ${generateTechStack(category, techStackAttr)}
                        </div>
                    </div>
                    ...
                    <ul class="testimonials-list has-scrollbar">
                        <li class="service-item">
                            <div class="service-content-header">
                                <div class="pathway-icon" aria-hidden="true">⏱️</div>
                                <h3 class="h4 key-features-item-title">Real-time Form Analysis</h3>
                            </div>
                            <div class="service-content-box">
                                <ul class="deliverables-points">
                                    <li><b>Deadlift:</b> Hip hinge detection & posture correction</li>
                                    <li><b>Squat:</b> Depth tracking & stability monitoring</li>
                                    <li><b>Bench Press:</b> Bar path tracking & symmetry assessment</li>
                                    <li><b>Instant Feedback:</b> Real-time guidance during exercises</li>
                                    <li><b>Rep Counting:</b> Precision-based repetition tracking</li>
                                </ul>
                            </div>
                        </li>
                        <li class="service-item">
                            <div class="service-content-header">
                                <div class="pathway-icon" aria-hidden="true">📊</div>
                                <h3 class="h4 key-features-item-title">Performance Tracking</h3>
                            </div>
                            <div class="service-content-box">
                                <ul class="deliverables-points">
                                    <li><strong>Exercise Metrics:</strong> Lockout angles, depth, and execution timing</li>
                                    <li><b>Session Statistics:</b> Historical workout data & trends</li>
                                    <li><b>Progress Visualization:</b> Bar path tracking & symmetry assessment</li>
                                    <li><b>Instant Feedback:</b> Graphical insights into performance improvements</li>
                                    <li><b>Data Privacy:</b> Local storage to ensure user security</li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="testimonials-list has-scrollbar">
                        <li class="testimonials-item">
                            <div class="content-card" data-testimonials-item="">
                                ...
                                <div class="delivery-header">
                                    <h3 class="h4 testimonials-item-title" data-testimonials-title="">Android Application</h3>
                                    <a href="https://play.google.com/store" target="_blank" rel="noopener" aria-label="View on Google Play Store">
                                        <img src="./assets/images/icon quote.svg" alt="Download link">
                                    </a>
                                </div>
                        ...
                        <li class="testimonials-item">
                            <div class="content-card" data-testimonials-item="">
                                ...
                                <div class="delivery-header">
                                    <h3 class="h4 testimonials-item-title" data-testimonials-title="">iOS Application</h3>
                                    <a href="https://apps.apple.com" target="_blank" rel="noopener" aria-label="View on App Store">
                                        <img src="./assets/images/icon quote.svg" alt="Download link">
                                    </a>
                                </div>
    ...
    // Prevent default nav click handler from interfering with Case Study nav
    const caseStudyNavBtn = document.querySelector("#case-study-nav .navbar-link");
    if (caseStudyNavBtn) {
        caseStudyNavBtn.addEventListener("click", function (e) {
            e.preventDefault();
            window.scrollTo(0, 0);
    ...
    // Existing event listeners for sidebar, testimonials, form, etc.
    const elementToggleFunc = function (elem) {
        elem.classList.toggle("active");
    };
